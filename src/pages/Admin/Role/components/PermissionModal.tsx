...
import { rolePermission } from '../service';
...
type PermissionModalProps = {
  ...
  onDone: () => void;
  onSubmit: (values: PermissionRoleData) => void;
};
const PermissionModal: React.FC<PermissionModalProps> = (props) => {
  ...
  const handleRolePermission = async (currentRow?: RoleItem) => {
  ...
  return (
    <ModalForm<RoleItem>
      title={(current ? current.display_name + ' 权限设置' : '') }
      visible={visible}
